<div class="py-8">
    ...
    <div class="mt-6">
        <a href="{{ route('plugin.fit-check.upload') }}" class="w-full bg-white/10 text-white font-bold py-3 rounded-xl hover:bg-white/20 transition-colors flex items-center justify-center gap-2">
